...
PRAVO_STAV_DOCUMENT_FILENAME_MARKERS = PRAVO_STAV_DOCUMENT_TITLE_MARKERS + (
    "subsid",
    "support",
    "apk",
    "agro",
...
def _has_pravo_document_filename(path: str) -> bool:
    ...
    return any(marker in filename for marker in PRAVO_STAV_DOCUMENT_FILENAME_MARKERS)
