...
class SourceConfig(BaseModel):
    ...
    enabled: bool = True
    parser: Literal["generic_html", "government", "regional_law", "krasnodar", "donland", "stavropol", "regulation_gov", "publication_pravo_stav", "mcx", "promote_budget", "pravo_stavregion_api"] = "generic_html"
