...
AHSTEP_EXCLUDED_TOPICS = _get_env_str_tuple(
    "AHSTEP_EXCLUDED_TOPICS",
    (
        "рыбохозяйственный комплекс,аквакультура,аквакультур,рыболовство,"
        "рыбоводство,рыбохозяйственный,водные биоресурсы,корма для аквакультуры,"
        "северные олени,оленеводство,КМНС,коренные малочисленные народы,"
        "родовые общины,пробирная палата,пробирное клеймо,"
        "государственное пробирное клеймо,драгоценные металлы,"
        "ювелирные изделия,ювелирный рынок,клеймение изделий"
    ),
)
